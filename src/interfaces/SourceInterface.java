 ...
 */
public class SourceInterface extends NetworkInterface {
	
	/**
	 * Reads the interface settings from the Settings file
	 */
	public SourceInterface(Settings s)	{
		super(s);
	}
	 ...
	 */
	public SourceInterface(SourceInterface ni) {
		super(ni);
	}

	public NetworkInterface replicate()	{
		return new SourceInterface(this);
	}
