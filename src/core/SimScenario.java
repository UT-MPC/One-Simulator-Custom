...
public class SimScenario implements Serializable {
	...
	public static final String APPCOUNT_S = "nrofApplications"; // this is wrong, its part of group namespace!!
	...
	protected void createHosts() {
		...
		for (int i=1; i<=nrofGroups; i++) {
			...
			for (int j=1; j<=appCount; j++) {
				...
				try {
					System.out.println("Trying to load an application");
